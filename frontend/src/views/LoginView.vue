  ...
  >
    <div class="w-full max-w-sm">
      ...
      <div class="rounded-2xl border border-slate-200/80 bg-white p-8 shadow-soft dark:border-slate-800 dark:bg-slate-900">
        <p class="mb-6 text-sm text-slate-500 dark:text-slate-400">Entre na sua conta para continuar</p>
        ...
        <p class="mt-4 text-center text-sm">
          <RouterLink to="/esqueci-senha" class="font-medium text-slate-500 hover:text-brand-600 hover:underline dark:text-slate-400 dark:hover:text-brand-400">
            Esqueci minha senha
          </RouterLink>
        </p>
      </div>
